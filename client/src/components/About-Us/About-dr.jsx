        ...
        <div className="about-dr">
            ...
            <div className="desc">
                ...
                <div className="dr-desc">
                    Dr. Mohammad Irshad Ahmed, the son of the late Dr. Mohammed Rasheed Ahmed, now leads the center with a deep sense of purpose and responsibility. A highly qualified and compassionate medical professional, Dr. Irshad brings both modern medical knowledge and a strong ethical foundation to the center.
