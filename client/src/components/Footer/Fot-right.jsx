    ...
    return (
        <div className="footer-right">
            ...
            <div className="socials">
                <a href="https://www.instagram.com/visiondiagnosticcentre5/?hl=en"> <InstagramIcon className="social-icon" style={{ fontSize: "2.6rem", color: " black" }} /></a>
                <a href=""> <FacebookIcon className="social-icon" style={{ fontSize: "2.6rem", color: " black" }} /></a>
                <a href=""> <EmailIcon className="social-icon" style={{ fontSize: "2.6rem", color: " black" }} />visiondiagnostic24@gmail.com </a>
            </div>
            <iframe
